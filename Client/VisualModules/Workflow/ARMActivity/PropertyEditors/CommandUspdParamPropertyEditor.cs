...
namespace Proryv.Workflow.Activity.ARM
{
    ...
    class CommandUspdParamPropertyEditor : DialogPropertyValueEditor
    {
        ...
        public CommandUspdParamPropertyEditor()
        {
        ...
        public override void ShowDialog(PropertyValue propertyValue, IInputElement commandSource)
        {
            ...
            Manager.Modules.CreateCommandDialogUSPD(oldSetting, delegate(CommandInfo command)
            {
                isCloseDialog = true;
