...
{
    public class GetE422TIList : BaseArmActivity<bool>
    {
        public GetE422TIList()
        {
            DisplayName = "Получить список ТИ для E422";
        }
        [Category(ActivitiesSettings.PropertyGridCategoryName_In)]
        [DisplayName("Идентификатор E422")]
        [RequiredArgument]
        public InArgument<Int32> E422_ID { get; set; }
        ...
        {
            if (TIList == null)
                metadata.AddValidationError("Не определено свойство 'Список идентификаторов ПУ'");
        ...
        protected override bool Execute(CodeActivityContext context)
        {
            ...
            string sql = @"set nocount on;set transaction isolation level read uncommitted;select TI_ID from  Info_Meters_TO_TI join Hard_MetersE422_Links on Hard_MetersE422_Links.METER_ID=Info_Meters_TO_TI.METER_ID where E422_ID=" + E422_ID.Get(context);
            try
            {
